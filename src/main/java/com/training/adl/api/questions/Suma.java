...
import com.training.adl.api.models.calculator.AddResponse;
...
public class Suma implements Question {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        AddResponse response = LastResponse.received().
                answeredBy(actor).
                as(AddResponse.class);

        actor.should(
                seeThat(TheValue.of("Resultado de la suma ", actor.recall(Constants.RESULTADOSUMA)), equalTo(response.getAddResult()))
