package com.training.adl.api.utilities;
...
public class SoapMapper implements ObjectMapper {
    ...
    public Object deserialize(ObjectMapperDeserializationContext context) {
        ...
        Class<?> clazz = (Class<?>) ((ObjectMapperDeserializationContextImpl) context).getType();
        ...
        try {
            ...
            LogPrinter.printErrror(" error en deserializar " + e.toString());
        }
